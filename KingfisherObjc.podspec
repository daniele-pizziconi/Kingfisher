Pod::Spec.new do |s|
  ...
  s.name         = "KingfisherObjc"
  s.version      = "6.0.1-objc"
  ...
  s.homepage     = "https://github.com/daniele-pizziconi/Kingfisher"
  ...
  s.source       = { :git => "https://github.com/daniele-pizziconi/Kingfisher.git", :tag => s.version }
